...
EGO_SUM=(
	...
	"code.rocketnine.space/tslocum/cview v1.5.6-0.20210530175404-7e8817f20bdc/go.mod"
	...
	"github.com/makeworld-the-better-one/go-gemini v0.12.1/go.mod"
	...
	"github.com/mmcdole/gofeed v1.1.2/go.mod"
	...
	"github.com/rkoesters/xdg v0.0.0-20181125232953-edd15b846f9b/go.mod"
...
SRC_URI="https://github.com/makeworld-the-better-one/amfora/archive/v${PV}.tar.gz -> ${P}.tar.gz
		${EGO_SUM_SRC_URI}"
